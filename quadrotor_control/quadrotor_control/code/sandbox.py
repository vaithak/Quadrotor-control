...
#######################################################################
from quadrotor_control.code.se3_control import SE3Control
from quadrotor_control.code.world_traj import WorldTraj
#######################################################################
...
my_world_traj = WorldTraj(world, start, goal, local=True)
...
# maximum number of features (that are in front of camera and within the predefined dist_threshold) to keep for VIO, increasing it will make VIO more robust, but the less efficient
